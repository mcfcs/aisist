(function (root) {
  ...
  const KEYS = { plan: term => `plan-v1:${term}`, sections: term => `sections-v1:${term}`, ips: 'ips-v1' };
  ...
  const api = {
    ...
    totalUnits, conflicts, duplicates, conflictLabel, sectionWarnings, sortPicks, usedDays, gridBounds, termLabel,
